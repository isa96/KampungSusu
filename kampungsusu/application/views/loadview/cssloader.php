...
<head>
  ...
  <title>Kampung Susu Adventure | Dashboard</title>
  ...
  <script src="<?php echo base_url('assets/plugins/exporting.js'); ?>" type="text/javascript"></script>
